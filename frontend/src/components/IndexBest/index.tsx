...
export function IndexBest() {
    const { data, error, isLoading } = useSWR(API.bestSubmissions, fetcher)
                ...
                {data.map((x: BestSubmission) => (
                    ...
                    >
                        <Stack h="100%" justify="space-between">
                            ...
                            <Group variant="noflip" wrap="nowrap" justify="space-between">
                                {x.isPoint ? (
                                    <Button
                                        c="white"
                                        classNames={{
                                ...
                                >
                                    <span style={{ color: "#0D7337" }}>{x.comments}</span>
                                </Badge>
                            </Group>
                        </Stack>
                    </Card>
